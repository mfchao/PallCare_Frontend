...
<template>
  <main>
    ...
    <text :style="styleObject" class="intro"
      >We are committed to respecting your legacy. Time Machine is our new concept to help you with it:
      <br />
      Set a date for your time machine which is: after a range of time you have not logged into our app, we will help you to automatically DELETE, SEND, or REVEAL some contents which you may later
      specify in our app.</text
    >
